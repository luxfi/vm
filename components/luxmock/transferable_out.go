...
//
//	mockgen -package=luxmock -destination=components/lux/luxmock/transferable_out.go -mock_names=TransferableOut=TransferableOut github.com/luxfi/vm/components/lux TransferableOut
//
