...
// Source: github.com/luxfi/vm/components/verify (interfaces: Verifiable)
//
// Generated by this command:
//
//	mockgen -package=verify -destination=components/verify/mock_verifiable.go github.com/luxfi/vm/components/verify Verifiable
//
