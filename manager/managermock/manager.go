...
// Source: github.com/luxfi/vm/manager (interfaces: Manager)
//
// Generated by this command:
//
//	mockgen -package=managermock -destination=managermock/manager.go -mock_names=Manager=Manager . Manager
//
