...
func (x *L1ValidatorRegistrationJustification) GetConvertChainToL1TxData() *ChainIDIndex {
	if x != nil {
		if x, ok := x.Preimage.(*L1ValidatorRegistrationJustification_ConvertChainToL1TxData); ok {
...
const file_platformvm_platformvm_proto_rawDesc = "" +
	...
	"platformvm\"\xd0\x01\n" +
	"$L1ValidatorRegistrationJustification\x12W\n" +
	"\x1cconvert_chain_to_l1_tx_data\x18\x01 \x01(\v2\x16.platformvm.ChainIDIndexH\x00R\x17convertChainToL1TxData\x12C\n" +
	"\x1dregister_l1_validator_message\x18\x02 \x01(\fH\x00R\x1aregisterL1ValidatorMessageB\n" +
	"\n" +
	"\bpreimage\"?\n" +
	"\n" +
	"ChainIDIndex\x12\x1b\n" +
	"\tchain_id\x18\x01 \x01(\fR\bchainId\x12\x14\n" +
	"\x05index\x18\x02 \x01(\rR\x05indexB)Z'github.com/luxfi/vm/proto/pb/platformvmb\x06proto3"
