...
const file_validatorstate_validator_state_proto_rawDesc = "" +
	...
	"\x0fGetNetIDRequest\x12\x19\n" +
	"\bchain_id\x18\x01 \x01(\fR\achainId\"/\n" +
	"\x10GetNetIDResponse\x12\x1b\n" +
	"\tchain_id\x18\x01 \x01(\fR\bchainId\"M\n" +
	"\x16GetValidatorSetRequest\x12\x16\n" +
	"\x06height\x18\x01 \x01(\x04R\x06height\x12\x1b\n" +
	"\tchain_id\x18\x02 \x01(\fR\bchainId\"<\n" +
	"\x1dGetCurrentValidatorSetRequest\x12\x1b\n" +
	"\tchain_id\x18\x01 \x01(\fR\bchainId\"\x81\x02\n" +
	"\tValidator\x12\x17\n" +
	...
	"validators\x18\x01 \x03(\v2\x19.validatorstate.ValidatorR\n" +
	"validators\x12%\n" +
	"\x0ecurrent_height\x18\x02 \x01(\x04R\rcurrentHeight2\xe8\x03\n" +
	"\x0eValidatorState\x12T\n" +
	"\x10GetMinimumHeight\x12\x16.google.protobuf.Empty\x1a(.validatorstate.GetMinimumHeightResponse\x12T\n" +
	"\x10GetCurrentHeight\x12\x16.google.protobuf.Empty\x1a(.validatorstate.GetCurrentHeightResponse\x12M\n" +
	"\bGetNetID\x12\x1f.validatorstate.GetNetIDRequest\x1a .validatorstate.GetNetIDResponse\x12b\n" +
	"\x0fGetValidatorSet\x12&.validatorstate.GetValidatorSetRequest\x1a'.validatorstate.GetValidatorSetResponse\x12w\n" +
	"\x16GetCurrentValidatorSet\x12-.validatorstate.GetCurrentValidatorSetRequest\x1a..validatorstate.GetCurrentValidatorSetResponseB-Z+github.com/luxfi/vm/proto/pb/validatorstateb\x06proto3"
