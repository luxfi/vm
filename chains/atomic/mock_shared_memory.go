...
// Source: github.com/luxfi/vm/chains/atomic (interfaces: SharedMemory)
//
// Generated by this command:
//
//	mockgen -package=atomic -destination=chains/atomic/mock_shared_memory.go github.com/luxfi/vm/chains/atomic SharedMemory
//
