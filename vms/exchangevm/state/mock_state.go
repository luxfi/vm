...
// Source: github.com/luxfi/vm/vms/exchangevm/state (interfaces: Chain,State,Diff)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/xvm/state/mock_state.go github.com/luxfi/vm/vms/exchangevm/state Chain,State,Diff
//
