...
// Source: github.com/luxfi/vm/vms/proposervm (interfaces: PostForkBlock)
//
// Generated by this command:
//
//	mockgen -package=proposervm -destination=vms/proposervm/mock_post_fork_block.go github.com/luxfi/vm/vms/proposervm PostForkBlock
//
